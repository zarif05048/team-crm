...
import { UserCircle2, CheckCircle2, RotateCcw } from "lucide-react";
  ...
  return (
    <div className="flex items-center gap-2 border-b border-slate-200 bg-slate-50 px-4 py-2">
      ...
      <select
        ...
        disabled={pending}
        className="h-8 max-w-[180px] flex-1 rounded-lg border border-slate-300 bg-white px-2 text-sm text-slate-700 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 disabled:opacity-50"
      >
